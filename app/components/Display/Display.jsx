...
const Display = () => {
  ...
  return (
    ...
    >
      <motion.div className=" w-full mt-10 hidden md:block "
      ...
      <div className="item-center w-full justify-center">
        ...
        <div className="flex justify-center flex-col items-center mt-10 ">
          <motion.div className="relative  rounded-full md:h-40 md:w-40 w-20 h-20 mt-4 md:mt-0"
            ...
            <svg className="absolute inset-0 w-full h-full">
              ...
              <circle cx="50%" cy="50%" r="48%" className="stroke-current stroke-2 text-blue-500 rounded-full shadow-blue-500 animate-glow-border" fill="none" />
              {/* Outer circle for additional glow */}
              <circle cx="50%" cy="50%" r="55%" className="stroke-current stroke-2 text-blue-500 rounded-full shadow-blue-500 animate-glow-border" fill="none" />
            </svg>
          </motion.div>
        ...
        <div className="flex flex-col w-full mb-16  items-center justify-center">
          ...
          >
            <div class="flex  w-full items-center justify-center ">
              <h1
                class="relative top-0 w-fit h-auto  justify-center flex bg-gradient-to-r items-center from-blue-500 via-teal-500 to-pink-500 bg-clip-text text-2xl mt-4 md:mt-0 md:text-5xl font-bold text-transparent text-center select-auto">
                Hi, I'm  {typedText}
              </h1>
            </div>
          </motion.div>
          ...
          >
            I love to Develop user interfaces and web applications with latest technologies.
            Transforming ideas into reality through code.
          </motion.div>

          <motion.div className="flex gap-2 text-white mt-4"
            ...
            <button className="relative px-5 py-1 border-2 border-transparent hover:animate-glow-border">
              <svg className="absolute inset-0 w-full h-full">
                <rect x="1" y="1" width="calc(100% - 2px)" height="calc(100% - 2px)" className="stroke-current  stroke-2 hover:stroke-0  animate-glow-border-line text-[#3DB0E1] " fill="none" strokeDasharray="100%" />
              </svg>
      ...
      <motion.div className=" w-full mt-2 hidden md:block "
